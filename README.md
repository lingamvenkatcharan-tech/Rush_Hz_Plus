...
3. Download the Android app file
4. Open the file on your Android device
5. Allow installation from trusted sources if your phone asks
...
3. Keep the app running in the foreground
4. Hold the device close enough to hear nearby sounds
5. Feel the vibration when the app detects a hazard
...
### What if I do not feel the vibration?
